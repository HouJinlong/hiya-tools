...
export const renderFn =
  (data: RenderViewProps) =>
  (v: RenderViewProps['EditDataState']['layout'][0]) => {
...
export const RenderViewContext = React.createContext<RenderViewProps>(
  {} as any
);
export const useRenderViewContext = ()=>{
  return useContext(RenderViewContext)
}
export const RenderView = ({
  ...
  return (
    <RenderViewContext.Provider value={data}>
      <Warp>{transformLayout(data.EditDataState.layout, renderFn(data))}</Warp>
